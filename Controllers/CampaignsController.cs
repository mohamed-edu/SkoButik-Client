...
namespace SkoButik_Client.Controllers
{
    public class CampaignsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CampaignId,CampaignName,CampaignAmount,StartDate,EndDate")] Campaign campaign)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CampaignId,CampaignName,CampaignAmount,StartDate,EndDate")] Campaign campaign)
        {
